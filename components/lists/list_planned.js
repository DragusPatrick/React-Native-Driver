    ...
    render() {
            return (
                <View style={styles.item}>
                    <View style={(this.data.vehicle.bussiness_type == 'Business') ? styles.itemHeaderBusiness : styles.itemHeader}>
                        <Text style={{
                            fontSize: 14,
                            width: 260,
                            marginTop: 7,
                    ...
                    <View style={styles.footerItem}>
                        <Text style={(this.data.vehicle.bussiness_type == 'Business') ? styles.itemFooterBusiness : styles.itemFooter}>Arrived</Text>
